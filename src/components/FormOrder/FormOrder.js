...
const FormOrder = ({show, validated, setName, setEmail, setEmailConfirm, setPhone, handleShow, handleClose, handleSubmit}) => {
                ...
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                    ...
                    <Modal.Body>
                        <Form.Group className="mb-3" controlId="formBasicName">
                            ...
                            <Form.Control required type="text" placeholder="Ingrese Nombre y Apellido" onBlur={(e) => { setName(e.target.value) }} />
